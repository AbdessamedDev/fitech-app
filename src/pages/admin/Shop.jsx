  ...
  return (
    <div className="bg-secondary-100 min-h-dvh p-10">
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-secondary-700">Shop</h2>
      ...
      <div className="bg-white rounded-lg p-6 text-center text-secondary-400 text-sm">Products list coming soon...</div>
    </div>
  );
}